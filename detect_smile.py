...
#If you instead want to use a video file  you would update your command 
#to use the --video switch
#python detect_smile.py --cascade haarcascade_frontalface_default.xml
...
#--cascade is the path to a Haar cascade used to detect faces in images
ap.add_argument("-m", "--model", required=True,
	help="path to pre-trained smile detector CNN")
#, --model specifies the path to our serialized LeNet weights on disk
...
# keep on looping using while-loop
while True:
